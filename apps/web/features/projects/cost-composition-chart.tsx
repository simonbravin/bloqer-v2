  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-base">Composición real (devengado)</CardTitle>
        <CardDescription>
          Por tipo de costo en OC / facturas / subcontratos · Total{" "}
          {formatChartMoney(composition.totalAccruedCost)}
        </CardDescription>
      </CardHeader>
      <CardContent>
