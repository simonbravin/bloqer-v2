 ...
 * today (product calendar day). Displayed inline in tables/cards as a red badge with the day count.
 *
...
/** Whole days between a Date column and today's product calendar day. Not overdue → 0. */
