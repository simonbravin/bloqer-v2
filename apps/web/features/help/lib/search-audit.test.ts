...
test("probe common treasury/accounting queries return something useful", () => {
  const cases: { q: string; expectSlugIncludes: string }[] = [
    ...
    { q: "preferencias email", expectSlugIncludes: "configurar-emails" },
    { q: "digest", expectSlugIncludes: "configurar-emails" },
    { q: "demasiados mails", expectSlugIncludes: "configurar-emails" },
