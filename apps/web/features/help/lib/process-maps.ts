...
export const HELP_PROCESS_MAPS: readonly HelpProcessMap[] = [
  ...
  },
  {
    ...
    kind: "flow",
    level: "project",
    title: "Desvío de OC: si esto, entonces aquello",
    summary: "Cuándo hay que justificar y cuándo la partida global no bloquea.",
    articleSlug: "orden-de-compra-y-afectar-edt",
    imageSrc: "/help/mapa-flujo-desvio-oc-si-no.png",
    guideRef: "§9.2",
  },
  {
    id: "costo-obra-si-no",
  ...
  },
  {
    ...
    summary: "Excel o a mano, reordenar partidas y armar el análisis de precio.",
    articleSlug: "armar-presupuesto-edt-apu",
    imageSrc: "/help/mapa-cargar-edt-apu.png",
    guideRef: "§6.1",
  },
  {
    id: "armar-cronograma",
    ...
    summary: "Importar la EDT, fechas, dependencias FS, hitos y reordenar.",
    articleSlug: "importar-cronograma",
    imageSrc: "/help/mapa-armar-cronograma.png",
    guideRef: "§7",
  },
  {
    id: "compra-sc-oc",
