...
export const PLANNING_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Después podés subir/bajar o sangrar desde el Gantt, la tabla o el detalle.",
    ...
    relatedSlugs: ["importar-cronograma", "cuatro-dimensiones-de-avance", "cargar-libro-de-obra", "recibir-una-oc"],
    keywords: ["hito", "milestone", "orden", "llegada", "paneles", "cronograma", "ubicación", "recepción", "entrega oc"],
    guideRef: "§7",
  },
  {
