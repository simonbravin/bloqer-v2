...
export const PROCUREMENT_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "En Nueva solicitud: primero Dónde se usa (partida EDT obligatoria, en orden de código). En Qué necesito podés agregar varias líneas de la misma partida (+ Agregar insumo o Agregar faltantes). Cada insumo APU no se repite; al elegirlo se precarga descripción, unidad y faltante (necesidad − ya pedido). Después la fecha requerida.",
