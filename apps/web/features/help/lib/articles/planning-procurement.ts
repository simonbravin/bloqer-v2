...
export const PLANNING_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Operativo: revisá faltante = necesidad − max(pedido, facturado).",
      "Pedir → SC prellenada (tipo Mano de obra vía APU) → cotizar → OC → factura.",
      "O Registrar factura → factura AP directa tipada Mano de obra (jornal / cuadrilla / empleado); el vínculo al insumo APU se guarda para el tablero.",
    ...
    pitfalls: [
      ...
      "Si cambiás la partida EDT en la factura, se limpia el vínculo APU: revisá el tipado.",
    ],
    relatedSlugs: [
      "tablero-equipos",
      "tablero-materiales",
  ...
  },
  {
    ...
    steps: [
      ...
      "Pedir → SC/OC tipada Equipos, o Registrar factura mensual tipada Equipos.",
...
export const PROCUREMENT_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "En Nueva solicitud: primero Dónde se usa (partida EDT obligatoria, en orden de código). En Qué necesito podés agregar varias líneas de la misma partida (+ Agregar insumo o Agregar faltantes). Cada insumo APU no se repite; al elegirlo se precarga descripción, unidad, faltante (necesidad − ya pedido) y monto est. de ese insumo (cant. × ref. presup. del APU). Después la fecha requerida.",
