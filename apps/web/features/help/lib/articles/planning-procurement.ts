...
export const PROCUREMENT_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      "En el detalle de la OC, debajo del título, hay una pista de proceso (Borrador → Aprobar → Confirmar → Recibir → Facturar → Pagar) que se actualiza con el estado y con recepción/factura/pago. El badge de estado se mantiene.",
