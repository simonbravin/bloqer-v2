...
export const PLANNING_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Después podés reordenar con el botón ⋮ de la fila (Gantt, tabla o detalle).",
  ...
  },
  {
    ...
    summary: "Bajá la tabla y el Gantt con los filtros que tengas aplicados.",
    ...
    steps: [
      ...
      "Aplicá los filtros que quieras (tipo, estado, solo atrasados, presupuesto).",
      "Pulsá Exportar y elegí Excel o PDF.",
      "El PDF es apaisado y se parte en páginas: tabla de fechas, tabla de avance/costos, y Gantt (el eje largo sigue en hojas siguientes). Cada página lleva empresa y obra.",
      "El Excel trae hoja Tabla (fechas dd/mm/aaaa) y hoja Gantt con celdas del mismo color que las barras.",
    ],
    effects: [
      "Se descarga un archivo con los ítems visibles según el filtro (las canceladas siguen ocultas salvo que filtres Cancelado).",
    ],
    pitfalls: [
      "En el celular no está el botón: usá escritorio o una ventana ancha.",
      "El Gantt del PDF usa el rango de fechas de los ítems filtrados, no el zoom de la pantalla.",
    ],
