...
export const PROCUREMENT_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Monto est. en el listado: suma solo los insumos APU ligados en la solicitud (badge Presup.), o el total de la cotización elegida (Cotización). Líneas sin insumo APU no entran al estimado presupuestario.",
      "Fecha requerida: obligatoria. Es cuándo se necesita en obra y aparece como Necesaria para en el listado y en Pendientes.",
      "Guardar DRAFT → Enviar (SUBMITTED). En el detalle ves una pista de proceso (Borrador → Enviada → Cotizando → Elegida → Completada) además del badge de estado. Quienes pueden cotizar la ven en Pendientes. La campana de nueva solicitud va a quien aprueba SC/OC (y OWNER/ADMIN), no necesariamente a todos los que cotizan.",
      "Cargar cotizaciones: elegí proveedor por razón social o nombre fantasía, precio unitario, Desc. % opcional (antes de IVA), alícuota IVA y —si el proveedor te dio el total con IVA— marcá El precio unitario incluye IVA. Ves neto, IVA y total por línea antes de guardar. Plazo y vigencia según política.",
      "Cotización Recibida sin seleccionar: Editar o Eliminar si te equivocaste (solo mientras la SC sigue Enviada).",
    ...
    pitfalls: [
      ...
      "Varios insumos APU van como líneas distintas en la misma SC; la cotización debe cubrir todas las líneas.",
      ...
      "Una cotización ya seleccionada o con OC generada no se edita: anulá la OC borrador o devolvé la SC según el caso.",
    ],
    relatedSlugs: [
      "tablero-materiales",
      "tablero-mano-obra",
