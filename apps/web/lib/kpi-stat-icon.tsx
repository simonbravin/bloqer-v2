...
const KEY_ICON: Record<string, { Icon: LucideIcon; accent: KpiIconAccent }> = {
  ...
  budget_cost_to_sale: { Icon: Percent, accent: "default" },
  budget_costliest_item: { Icon: TrendingUp, accent: "warning" },
  budget_top_incidence: { Icon: PieChart, accent: "info" },
  budget_dominant_category: { Icon: Calculator, accent: "default" },
  ...
  gl_drafts: { Icon: FileEdit, accent: "warning" },
  gl_posted_month: { Icon: BookOpen, accent: "info" },
  gl_month_result: { Icon: TrendingUp, accent: "success" },
  gl_assets: { Icon: Landmark, accent: "success" },
