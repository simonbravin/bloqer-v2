...
import { listCollectionsByProject, ServiceError } from "@bloqer/services";
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Cobranzas</h1>
        </div>
        <Button asChild>
      ...
      <div className="rounded-lg border bg-card">
        ...
        <div className="p-6">
          <CollectionList collections={items} projectId={id} />
        </div>
      </div>
    </div>
  );
