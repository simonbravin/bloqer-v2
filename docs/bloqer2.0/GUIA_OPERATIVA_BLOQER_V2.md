...
1. **Agregar documento** sube el archivo a la biblioteca de la obra (hasta **50 MB**; PDF, imágenes, Word, Excel, CSV, texto). La subida va directo al almacenamiento; no hace falta comprimir planos de unos pocos MB.
