...
4. En la tabla, la columna **Acciones** no muestra texto: el icono de ojo **abre** el archivo. En fotos **jpeg/png/webp** abre un **visor a pantalla completa** (si hay varias en el listado, flechas / teclado para pasar); los **PDF** (y HEIC según el navegador) se abren en una pestaña nueva. El icono de descarga **baja** el archivo. El nombre abre el detalle (en el detalle, clic en la preview también amplía la foto).
