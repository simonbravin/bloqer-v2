...
3. Adjuntar fotos y observaciones. En **Adjuntos**, la columna **Acciones** es una sola fila de iconos: ojo (**Ver**), flecha (**Descargar**), caja (**Archivar**) y tacho (**Eliminar**). Archivar y eliminar piden confirmación. En fotos **jpeg/png/webp**, **Ver** (o la miniatura en el celular) abre un **visor a pantalla completa**; si hay varias fotos en el mismo listado, podés pasar a la siguiente con las flechas o el teclado. Los **PDF** siguen abriéndose en una pestaña nueva; HEIC u otros tipos se descargan o se abren según el navegador.
