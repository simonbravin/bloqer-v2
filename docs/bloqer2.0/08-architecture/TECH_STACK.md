...
| Gráficos | **Recharts** |
| Gantt / planificación | **Kibo UI** (`gantt`, `calendar`, `kanban`) en `apps/web/components/kibo-ui/`; **adapters** en `apps/web/features/schedule/adapters/`; vistas en `features/schedule/components/` (ADR-007) |
