...
| `/finanzas/gastos-generales` | Same | **Imputación GG** (`VIEW AP`); cierre de período AUTO (`EDIT AP`). Alta corporativa: `/finanzas/facturas-proveedor/nueva` o `transacciones?register=ap`. |
