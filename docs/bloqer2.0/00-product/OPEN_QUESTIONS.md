...
- **Default operativo ([D-092], 2026-08-26):** mientras no haya selector de empresa, si el tenant tiene **una sola** `Company` ACTIVE se ancla sola (sesión, invitaciones, membresías, proyectos). 0 o 2+ empresas → no se elige. Cada tenant opera como 1:1 con su razón social hasta Q-001/0B.
...
### Q-060 — Oleada B compras (post Pendientes-portero / UX)
