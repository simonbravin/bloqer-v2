...
| Encender/apagar edición excepcional de presupuesto `APPROVED` (tenant y/o obra) ([D-088]) | OWNER, ADMIN | Default OFF; ambos flags ON para editar partidas + economía; `CLOSED` nunca |
