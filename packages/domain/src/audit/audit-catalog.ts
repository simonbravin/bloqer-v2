...
export const AUDIT_ACTION_LABELS_ES: Record<string, string> = {
  ...
  "purchase_order.submitted": "Orden de compra enviada",
  "purchase_order.approved": "Orden de compra aprobada",
  "purchase_order.returned_for_changes": "Orden de compra devuelta",
  "purchase_order.confirmed": "Orden de compra confirmada",
  "purchase_order.cancelled": "Orden de compra anulada",
  "purchase_request.created": "Solicitud de compra creada",
  "purchase_request.updated": "Solicitud de compra actualizada",
  "purchase_request.submitted": "Solicitud de compra enviada",
  "purchase_request.returned_for_changes": "Solicitud de compra devuelta a borrador",
  ...
  "wbs_node.added": "Ítem EDT agregado",
  "wbs_node.updated": "Ítem EDT actualizado",
  "wbs_node.removed": "Ítem EDT eliminado",
  "wbs_nodes.reordered": "Ítems EDT reordenados",
  ...
  "schedule_item.wbs_linked": "EDT vinculado a tarea",
  "schedule_item.wbs_unlinked": "EDT desvinculado de tarea",
  ...
  "journal_entry.reversed": "Asiento revertido",
  "journal_entry.auto_draft_skipped": "Asiento automático omitido",
  "journal_entry.auto_draft_created": "Asiento borrador automático creado",
  ...
  "accounting_coa_template.applied": "Plantilla de plan de cuentas aplicada",
